...
class YoutubePlayerFlags {
  ...
  /// Defines whether to show or hide the Playback Speed button in the live player.
  ///
  /// Default is true.
  final bool showPlaybackSpeedButton;

  /// Defines whether to show or hide the full screen button in the live player.
  ///
  /// Default is true.
  ...
  YoutubePlayerFlags copyWith({
    ...
    return YoutubePlayerFlags(
      ...
      controlsVisibleAtStart: controlsVisibleAtStart ?? this.controlsVisibleAtStart,
      ...
      showPlaybackSpeedButton: showPlaybackSpeedButton ?? this.showPlaybackSpeedButton,

...
class _ProgressBarState extends State<ProgressBar> {
  ...
  Widget _buildBar() {
    bool disableDragSeek = _controller.flags.disableDragSeek;
...
class _ProgressBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint.color = colors?.backgroundColor ?? Colors.red.withOpacity(0.38);
    canvas.drawLine(startPoint, endPoint, paint);

    paint.color = colors?.bufferedColor ?? Colors.white;
